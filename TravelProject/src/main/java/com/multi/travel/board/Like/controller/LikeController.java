...
/*	
	...
	public void QnAlist(Model model, QnaDto dto)
	{
		...
		List<QnaDto> list = likeService.getList(dto);
		int total = likeService.getTotal(dto);
	...
	{
		QnaDto viewDto = likeService.getView(dto.getQna_seq());
		QnaDto prevDto = likeService.getPrev(viewDto);
		QnaDto nextDto = likeService.getNext(viewDto);
	...
	public void write(QnaDto dto, String mode,Model model)
	{
		...
		{
			resultDto = likeService.getView(dto.getQna_seq());
	...
	@RequestMapping("/board/qna/update")
	public @ResponseBody 
	String update(LikeDto dto,
