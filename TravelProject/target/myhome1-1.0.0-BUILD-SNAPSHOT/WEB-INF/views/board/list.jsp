			...
			<table cellspacing="0" summary="[게시판명 프로그램입력]의 게시물 목록 입니다." class="bdl">
				...
				<%
					...
					for(int i=0; i<list.size(); i++){
						...
						String url=commonURL + "/board/view?board_seq="
...
function goDelete(board_seq)
{
	if( confirm("삭제하시겠습니까? "))
	{
		var url="${commonURL}/board/delete";
		$.ajax({
			url:url,
...
$(document).ready(function(){
	$("#btnWrite").click(function(){
		...
		$("#mform").attr("action", "${commonURL}/board/write");
		$("#mform").prop("action", "${commonURL}/board/write");
