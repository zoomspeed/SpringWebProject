...
<!--[if gt IE 8]><!--> <html class="no-js"> <!--<![endif]-->
	...
	<title>Listing 100% Free Fully Responsive HTML5 Template by FREEHTML5.co</title>
	...
	<body>
			...
			<header id="fh5co-header-section">
				<div class="container">
					<div class="nav-header">
						...
						<h1 id="fh5co-logo"><a href="/travel/member/logout">Listing</a></h1>
		...
		<div>
			<c:if test="${email==null || email==''}">	
				<div class="box"/>
					<a href="/travel/member/logon">로그온</a>
				</div>		
				<div class="box"/>
					<a href="/travel/member/member_write">
					회원가입</a>
				</div>
			</c:if>
			...
			<c:if test="${email!=null && email!=''}">	
				...
				사용자아이디 : ${member_id} <br>
				<div class="box"/>
					<a href="/travel/member/logout">로그아웃</a>
				</div>
			</c:if>
		</div>
		...
		<div class="fh5co-hero">
			...
			<div class="fh5co-cover text-center" data-stellar-background-ratio="0.5" style="background-image: url(images/cover_bg_1.jpg);">
				<div class="desc animate-box">
					...
					<span><a class="btn btn-primary btn-lg" href="/travel/board/list">Get Started</a></span>
				</div>
			</div>
		</div>
