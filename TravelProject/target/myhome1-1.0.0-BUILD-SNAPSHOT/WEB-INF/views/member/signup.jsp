...
<!-- /font files  -->
<!-- css files -->
<link href="${commonURL}/resources/template/css/style.css" rel='stylesheet' type='text/css' media="all" />
<!-- /css files -->
</head>
<body>
...
<div class="log">
	...
	<div class="content2 w3agile">
		...
		<form action="#" method="post">
			<input type="text" name="userid" value="Name" onfocus="this.value = '';" onblur="if (this.value == '') {this.value = 'Name';}">
		...
		<h3>Already have an account? <a href="${commonURL}/member/login">Sign In</a></h3>
	</div>
</div>
<div class="footer">
